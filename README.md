...
```javascript
uncapitalize = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-uncapitalize@v0.0.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/string-base-uncapitalize@v0.0.2-umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/string-base-uncapitalize/actions/workflows/test.yml/badge.svg?branch=v0.0.2
[test-url]: https://github.com/stdlib-js/string-base-uncapitalize/actions/workflows/test.yml?query=branch:v0.0.2
